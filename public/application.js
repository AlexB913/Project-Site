	...
	(0, _jquery2['default'])(function () {
	  ...
	  var app = {
	    ...
	    render: function render() {
	      ...
	      app.unbindEvents();
	      (0, _jquery2['default'])('.list-group').html(todoHtml.join(''));
	      app.bindEvents();
	    },
	    ...
	    bindAddTodoEvents: function bindAddTodoEvents() {
	      var handleEvent = function handleEvent() {
	        ...
	        if (_jquery2['default'].type(newTodoTitle) === 'string' && newTodoTitle.length > 2) {
	      ...
	      (0, _jquery2['default'])('.add-todo-container button').bind('keydown', 'ctrl+a', handleEvent);
	      (0, _jquery2['default'])('.add-todo-container button').on('click', handleEvent);
	    },
